...
var addFavorite = function addFavorite(success, failure, id, tag) {
  // debugger
  console.log('here');
  $.ajax({
    method: 'POST',
...
var getFavorite = function getFavorite(success, failure) {
  $.ajax({
    method: 'GET',
    url: config.apiUrl + 'favorites',
    headers: {
...
var deleteFavorite = function deleteFavorite(success, failure, id) {
  $.ajax({
    method: 'DELETE',
...
var editFavorite = function editFavorite(success, failure, id, tag) {
  $.ajax({
    method: 'PATCH',
    url: config.apiUrl + 'favorites/' + id,
    headers: {
...
var favoritesApi = __webpack_require__(4);
var jribbble = __webpack_require__(7);
...
var addFavoriteSuccess = function addFavoriteSuccess(data) {
  console.log(data);
  $('#tagModal').modal('hide');
  $('.modal-backdrop').hide();
...
var dribbbleFavorites = function dribbbleFavorites(data) {
  console.log(data);
  var favoriteShots = [];
  // debugger
  ...
  setTimeout(function () {
    console.log(favoriteShots);
    var getfavoritesTemplate = __webpack_require__(15);
...
var deleteFavoriteSuccess = function deleteFavoriteSuccess() {
  $('#carousel-example-generic').html(''); // reloads html
  favoritesApi.getFavorite(dribbbleFavorites, failure);
};

var editTagSuccess = function editTagSuccess() {
...
module.exports = {
  ...
  dribbbleFavorites: dribbbleFavorites,
...
/* WEBPACK VAR INJECTION */(function(module) {/* Jribbble 3.0.0 | Mon Apr  9 11:57:04 EDT 2018 - Copyright (c) 2018, Tyler Gaw me@tylergaw.com - Released under the ISC-LICENSE @license */
...
var authApi = __webpack_require__(35);
...
var authFavorites = __webpack_require__(4);
var authUi = __webpack_require__(6);
var jribbble = __webpack_require__(7);
...
var addFavoriteID = void 0;
var editFavoriteID = void 0;
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <div class=\"favoriteHolder\">\n    <img src=\""
    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.shot : depth0)) != null ? stack1.images : stack1)) != null ? stack1.normal : stack1), depth0))
    + "\" class=\"favoriteImage\">\n    <div class=\"textHolder\">\n      <h2 class=\"favoriteTitle\">"
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.shot : depth0)) != null ? stack1.title : stack1), depth0))
    + "</h2>\n      <div class=\"favoriteHover\">\n        <p><div class=\"favoriteTag\">"
    + alias2(alias1((depth0 != null ? depth0.tag : depth0), depth0))
    + "</div></p>\n        <p><a href=\"#\" class=\"editTag\" data-id="
    + alias2(alias1((depth0 != null ? depth0.railsID : depth0), depth0))
    + ">Change Tag</a></p>\n        <p><a href=\"#\" class=\"deleteFavorite\" data-id="
    + alias2(alias1((depth0 != null ? depth0.railsID : depth0), depth0))
    + ">Remove from Favorites</a></p>\n      </div>\n    </div>\n  </div>\n";
